...
- Experimentos y pruebas personales

Algunos repositorios destacados:
 🔹 **hello-git**  
  Práctica de control de versiones con Git y GitHub (ramas, merges, flujo de trabajo).

- 🔹 **Convertidor-hexadecimal**  
  Convertidor de números decimales a hexadecimal como proyecto de práctica de lógica y programación.
...
- Prepararme para el ámbito profesional y laboral
